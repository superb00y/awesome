...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "Return", function()
		awful.spawn("ghostty")
	end, { description = "Spawn ghostty terminal", group = "Awesome" }),
	...
	awful.key({ modkey }, "t", function()
		awful.spawn.with_shell(" rofi -modi filebrowser -show filebrowser -theme ~/.config/rofi/file.rasi ")
	end, { description = "file-browser", group = "Apps" }),
