...
wallpaper.setup({
	set_function = beautiful.awesome_wall == "cairo_text" and wallpaper.setters.text_wallpaper
		or (
			beautiful.awesome_wall == "cairo_svg" and wallpaper.setters.svg_wallpaper
			or wallpaper.setters.awesome_wallpaper
		),
	recursive = false,
	ignore_aspect = true,
	text = "superbOOy",
	...
	font_size = 200,
	path = "/home/superb00y/.config/awesome/assets/cairo_svg/arch-TM.svg",
	colors = {
		bg = beautiful.bg_dim,
