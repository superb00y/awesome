...
return function()
	...
	local shot_btn_full = shotbtn_widget(beautiful.shotfull, function()
		awful.spawn.easy_async_with_shell("/home/superb00y/.config/awesome/scripts/screenshot full ")
		naughty.notify({
			title = "Screenshot",
			message = "Saved to ",
			actions = {},
	...
	local shot_btn_area = shotbtn_widget(beautiful.shotarea, function()
		awful.spawn.easy_async_with_shell("/home/superb00y/.config/awesome/scripts/screenshot area ")
	end)

	local shot_btn_areamagick = shotbtn_widget(beautiful.shotareamagick, function()
		awful.spawn.easy_async_with_shell("/home/superb00y/.config/awesome/scripts/screenshot areamagick ")
	end)

	local shot_btn_active = shotbtn_widget(beautiful.shotactive, function()
		awful.spawn.easy_async_with_shell("/home/superb00y/.config/awesome/scripts/screenshot active ")
	end)

	local shot_btn_activemagick = shotbtn_widget(beautiful.shotactivemagick, function()
		awful.spawn.easy_async_with_shell("/home/superb00y/.config/awesome/scripts/screenshot activemagick ")
	end)
